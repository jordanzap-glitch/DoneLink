                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title">₱<?php echo number_format($salesPerMonth, 2); ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4">
              <div class="card card-warning card-round">
                <div class="card-header">
                  ...
                  <div class="card-category">Current Month: <?php echo date('F Y'); ?></div>
                </div>
                <div class="card-body pb-0">
                  <div class="mb-4 mt-2">
                    <h1>₱<?php echo number_format($salesPerMonth, 2); ?></h1>
                  </div>
                  <div class="pull-in">
